  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <TimeInput title="WORK TIME:" onChange={this.updateTime('work')} value={this.state.workTime} />
        <TimeInput title="BREAK TIME:" onChange={this.updateTime('break')} value={this.state.breakTime} />
      </View>
    )
  }
}
